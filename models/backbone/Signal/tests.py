...
def parse_args():
    ...
    parser.add_argument("--lr_decay_epochs", type=str, default="50,80,120", help="the epoch to adjust the lr")
    ...
    # model parameters
    parser.add_argument("--model", type=str, default="mcswin_t",
...
def main():
    ...
    print("Total testing time: {:.2f} seconds".format(total_test_time))
